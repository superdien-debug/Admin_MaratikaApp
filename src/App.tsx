      ...
      <div className="max-w-5xl mx-auto">
        <header className="flex justify-between items-center mb-10">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={() => { setEditingId(null); setForm({ title: '', content: '', excerpt: '', image_url: '' }); }}
        ...
        {(editingId !== null || (form.title || form.content)) && (
          <section className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-10">
            ...
            <div className="grid gap-5">
              ...
              <div className="flex justify-end gap-3 pt-4">
                <button onClick={() => { setEditingId(null); setForm({ title: '', content: '', excerpt: '', image_url: '' }); }} className="px-5 py-2.5 rounded-lg font-bold text-slate-500 hover:bg-slate-100 transition-colors flex items-center gap-2">
                  <X size={18} /> Cancel
                </button>
